...
Xyce simulation output files (`.raw`) directly — useful for re-examining
results from a previous run or analyzing output produced by a
command-line Xyce session.
