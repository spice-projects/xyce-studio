# Overlay of the registry skia port (vcpkg/ports/skia), kept in-tree so we can
# carry one extra patch:
#
#   015-floor-macos-target-at-13.3.patch -- gn/skia/BUILD.gn hardcodes
#     "-target <cpu>-apple-macos11" in asmflags/cflags/ldflags. That triple
#     overrides the -mmacosx-version-min=13.3 contributed by
#     VCPKG_OSX_DEPLOYMENT_TARGET in .triplets/*-osx.cmake (clang: "overriding
#     '-mmacosx-version-min=13.3' option with '-target x86_64-apple-macos11'"),
#     so libskia.dylib shipped minos 11.0 while every other binary shipped 13.3.
#
# This overlay shadows the registry port: when the vcpkg baseline is bumped,
# re-copy ports/skia here and re-apply the patch -- and keep the 13.3 in sync
# with CMAKE_OSX_DEPLOYMENT_TARGET (CMakeLists.txt) and .triplets/*-osx.cmake.
...
vcpkg_from_github(
    ...
    PATCHES
        ...
        # xyce-studio: floor skia's hardcoded "-target <cpu>-apple-macos11" at
        # 13.3 so libskia.dylib matches the rest of the build (see file header)
        015-floor-macos-target-at-13.3.patch
)
